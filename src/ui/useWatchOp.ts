...
export interface WatchOp {
   ...
   * the watch has never been paired. Failures become an alert titled
   * "<label> failed"; pass `onError` to handle them yourself instead (e.g. the
   * schedule/task reset-recovery flow).
   */
